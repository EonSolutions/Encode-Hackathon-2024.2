...
import { IFheAgentVerifierServerModule } from './IFheAgent.module';

export async function runIFheAgentVerifierServer() {
  const moduleClass = IFheAgentVerifierServerModule;
